...
public class PesquisaDAO {
    ...
    public ArrayList<Cliente> consultaTodosPorCPF(long cpf) throws SQLException {
        final Conect C = new Conect(); // instancia o método de conexão
        Connection conn = null; // cria uma nova variável de método Connection
        PreparedStatement pstm = null; // cria uma nova variável de método PreparedStatement
        String sql = "SELECT * FROM clientes";
    ...
    public ArrayList<Cliente> consultaTodosComCarro() throws SQLException {
        final Conect C = new Conect(); // instancia o método de conexão
        Connection conn = null; // cria uma nova variável de método Connection
        PreparedStatement pstm = null; // cria uma nova variável de método PreparedStatement
        String sql = "SELECT clientes.*, veiculos.modelo_veiculo FROM clientes, veiculos WHERE veiculos.id_clientes = clientes.id_clientes";
        ArrayList<Cliente> clientes = new ArrayList<>();
        //  List<Contato> contatos = new ArrayList<Contato>();
        ResultSet rset = null;
    ...
    public ArrayList<Cliente> consultaTodosComCarroPorCPF(long cpf) throws SQLException {
        final Conect C = new Conect(); // instancia o método de conexão
        Connection conn = null; // cria uma nova variável de método Connection
        PreparedStatement pstm = null; // cria uma nova variável de método PreparedStatement
        String sql = "SELECT clientes.*, veiculos.modelo_veiculo FROM clientes, veiculos WHERE veiculos.id_clientes = clientes.id_clientes";
