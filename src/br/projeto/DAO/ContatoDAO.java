 ...
 * na base de dados
         */
        String sql = "INSERT INTO contatos(id,nome,idade,dataCadastro)"
                + " VALUES(?,?,?,?)";
        Conect C = new Conect();
        ...
        try {
            ...
            pstm.setString(4, contato.getDataCadastro());
    ...
    public Contato getContatos(int codigo) {
        String sql = "SELECT * FROM contatos";
        Contato contato = new Contato();
        //  List<Contato> contatos = new ArrayList<Contato>();
        Conect C = new Conect();
