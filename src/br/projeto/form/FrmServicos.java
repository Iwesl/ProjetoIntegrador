...
public class FrmServicos extends javax.swing.JFrame {
    ...
    public void buscaTodasOsPlus() {
        try {
            ...
            for (int i = 0; i < cl.size(); i++) {
                // loop que pega os dados e insere na tabela
                Object[] dados = new Object[10]; // instancia os objetos. Cada objeto representa um atributo 
                dados[0] = cl.get(i).getNumero_OS();
                dados[1] = cl.get(i).getIdCliente_OS()+"--"+cl.get(i).getNomeCliente_OS();
                dados[2] = cl.get(i).getIdUsuario_OS()+"--"+cl.get(i).getNomeUsuario_OS();
                dados[3] = cl.get(i).getStatus_OS();
                dados[4] = cl.get(i).getDefeito_OS();
                dados[5] = cl.get(i).getObs_OS();
                dados[6] = cl.get(i).getDataAbertura_OS();
                dados[7] = cl.get(i).getDataFechamento_OS();
                dados[8] = cl.get(i).getNomePeca_OS();
                dados[9] = cl.get(i).getValorTotal_OS();
                // pega os dados salvos do banco de dados (que estão nas variáveis) e os coloca nos objetos definidos
