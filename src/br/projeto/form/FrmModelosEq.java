 ...
 * @author Igor
 */
public class FrmModelosEq extends javax.swing.JFrame {

    /**
     * Creates new form FrmModelosEq
     */
    public FrmModelosEq() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmModelosEq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmModelosEq().setVisible(true);
            }
        });
    }
